...
# read data
data <- read.csv("C:/Users/hinne/Desktop/BA Voice/EEG Data analysis EEG/Voice analysis/R analysis/Data/EEG_data_FCz.csv", header=T, na.strings = "NaN")
